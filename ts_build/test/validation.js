...
describe('Address Validation', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    chai_1.expect(isValidUriSingleParam).to.equal(true);
                    return [2];
            }
        });
    }); });
    it('should be able to validate an XRP Uri', function () { return __awaiter(_this, void 0, void 0, function () {
        var isValidUri, isValidUriParams, isValidUriSingleParam;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should be able to invalidate incorrect ETH Uri params', function () { return __awaiter(_this, void 0, void 0, function () {
        var inValidEthUri;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    chai_1.expect(inValidEthUri).to.equal(false);
                    return [2];
            }
        });
    }); });
    it('should be able to invalidate ETH URI without ethereum prefix', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    chai_1.expect(inValidEthPrefix).to.equal(false);
                    return [2];
            }
        });
    }); });
    it('should be able to invalidate incorrect XRP Uri params', function () { return __awaiter(_this, void 0, void 0, function () {
        var inValidXrpUri;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    chai_1.expect(inValidXrpUri).to.equal(false);
                    return [2];
            }
        });
    }); });
    it('should be able to invalidate XRP URI without ripple prefix', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    chai_1.expect(inValidXrpPrefix).to.equal(false);
                    return [2];
            }
        });
    }); });
