...
var VCLTxProvider = (function () {
    function VCLTxProvider() {
        this.lib = require('vircle-lib');
    }
    VCLTxProvider.prototype.selectCoins = function (recipients, utxos, fee) {
    ...
    VCLTxProvider.prototype.create = function (_a) {
        var _this = this;
    ...
    VCLTxProvider.prototype.getRelatedUtxos = function (_a) {
        var _this = this;
    ...
    VCLTxProvider.prototype.getOutputsFromTx = function (_a) {
        var tx = _a.tx;
    ...
    VCLTxProvider.prototype.getSigningAddresses = function (_a) {
    ...
    return VCLTxProvider;
}());
exports.VCLTxProvider = VCLTxProvider;
